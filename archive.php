			...
			<header class="page-header">
				<h1 class="page-title">
					<?php
						...
						elseif ( is_tax( 'portfolio_type', 'new-portfolios' ) ) :
							esc_html_e( '[:en]New Projects[:zh]最新项目', 'sparkling' );

						elseif ( is_tax( 'portfolio_type', 'past-portfolios' ) ) :
							esc_html_e( '[:en]Past Projects[:zh]过往项目', 'sparkling' );

						elseif ( is_tax( 'portfolio_type', 'all-portfolios' ) ) :
							esc_html_e( '[:en]All Projects[:zh]所有项目', 'sparkling' );

						elseif ( is_tax( 'team', 'lease-team' ) ) :
							esc_html_e( '[:en]Lease Team[:zh]租赁团队', 'sparkling' );
